        ...
        <ul class="navbar-nav align-items-md-center gap-md-4 gap-lg-5 bh-nav-links">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="productCategoriesDropdown">
              ...
              <li><a class="dropdown-item active" aria-current="page" href="Pastry.php">Pastry</a></li>
            </ul>
          </li>
        </ul>
      </div>
    ...
    <section class="dashboard-hero">
      ...
      <div class="container-fluid px-5 py-5 position-relative">
        <div class="dashboard-hero-content">
          ...
          <h1 class="display-5 fw-semibold mb-3">Pastry</h1>
          <p class="lead mb-0">Browse pastries and baked goods for your menu.</p>
        </div>
      </div>
    </section>

    <div class="container-fluid px-5 pb-5 mt-4 products-grid">
      <h3 class="text-center mt-5">Pastry</h3>
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5 g-3 mt-3">
        <div class="col"><div class="card h-100 shadow-sm border-0"><div class="card-body"><h6 class="card-title mb-0">Croissant</h6></div></div></div>
        <div class="col"><div class="card h-100 shadow-sm border-0"><div class="card-body"><h6 class="card-title mb-0">Muffin</h6></div></div></div>
        <div class="col"><div class="card h-100 shadow-sm border-0"><div class="card-body"><h6 class="card-title mb-0">Cinnamon Roll</h6></div></div></div>
        <div class="col"><div class="card h-100 shadow-sm border-0"><div class="card-body"><h6 class="card-title mb-0">Brownie</h6></div></div></div>
      </div>
    </div>
  </main>
